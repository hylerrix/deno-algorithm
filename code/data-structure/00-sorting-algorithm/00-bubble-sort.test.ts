...
Deno.test({
  ...
  fn(): void {
    assertEquals(bubbleSort(input), expect)
    assertEquals(bubbleSort(input_01), expect_01)
    assertEquals(bubbleSort(input_02), expect_02)
  },
})
...
Deno.test({
  ...
  fn(): void {
    assertEquals(bubbleSort_01(input), expect)
    assertEquals(bubbleSort_01(input_01), expect_01)
    assertEquals(bubbleSort_01(input_02), expect_02)
  },
})
...
Deno.test({
  ...
  fn(): void {
    assertEquals(bubbleSort_02(input), expect)
    assertEquals(bubbleSort_02(input_01), expect_01)
    assertEquals(bubbleSort_02(input_02), expect_02)
  },
})
